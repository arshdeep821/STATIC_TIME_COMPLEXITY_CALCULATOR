...
*Output: <br>
a = size of list parameter `nums` <br>
b = integer value of parameter `target` <br>
Time complexity of function `twoSum` is O(a)*
...
*Output: <br>
a = size of string parameter `s` string<br>
b = size of list parameter `stack` <br>
Time complexity of function `isValid` is O(a)*
